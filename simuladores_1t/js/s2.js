...
botao.onclick = function retorna()
{
    ...
    var inputt = document.getElementById('entrada').value;
    if(inputt == '' || inputt<=0)
	{
    ...
    {   
        if(select_reag1 == '1' && select_reag2 == '2' && select_corr == '1')
        {
            ...
            var resultadoCompleto = "44,8L H2 - 22,4L O2 <br>" +valor +"L H2 - XL O2 <br><br> 44,8 . X = 22,4 . " + valor + "<br> X = " + a + "/44,8 <br> X = " + b + "L O2";
            ...
            document.getElementById('result').innerHTML =  "Dado " + valor + "L de H2, precisa de " + b + "L de O2.";
        }
        ...
        if(select_reag1 == '2' && select_reag2 == '1' && select_corr == '1')
        {
            ...
            b = b.toFixed(2);
            produto = produto.toFixed(2);
            var resultadoCompleto = "44,8L H2 - 22,4L O2 <br>"  + "XL H2 -" + valor + "L O2 <br><br> 22,4 . X = " + "44,8 . " + valor +"<br> X = " + a + "/22,4 <br> X = "+ b + "L H2 ";
            document.getElementById('resultado').innerHTML = resultadoCompleto;
            document.getElementById('h2(1)').innerHTML = b;
            document.getElementById('o2(1)').innerHTML = valor;
            document.getElementById('h2o(1)').innerHTML = produto;
            document.getElementById('result').innerHTML = "Dado " + valor + "L de O2, precisa-se de " + b + "L de H2.";
        }
        ...
        if(select_reag1 == '2' && select_reag2 == '3' && select_corr == '2')
        {
            ...
            b = b.toFixed(2);
            produto = produto.toFixed(2);
            var resultadoCompleto = "18g H2O - 22,4L O2 <br> Xg H2O - " + valor + "L O2 <br><br> 22,4 . X = " + a + ". 1 <br> X = " + a + "/22.4 <br> X = " + b + "g H2O";
            document.getElementById('resultado').innerHTML = resultadoCompleto;
            ...
            document.getElementById('result').innerHTML = "Dado " + valor + "L O2, produzimos " + b + "g de H2O";
        }
        ...
        if(select_reag1 == '3' && select_reag2 == '2' && select_corr == '2')
        {
            ...
            b = b.toFixed(2);
            produto = produto.toFixed(2);
            var resultadoCompleto = "22,4L O2 -18g H2O <br> XL O2 - " + valor + "g H2O <br><br> 18 . X = " + valor + ". 22,4 <br> X = " + a + "/18 <br> X = " + b + "L O2 ";
            document.getElementById('resultado').innerHTML = resultadoCompleto;
            document.getElementById('h2').innerHTML = produto;
            document.getElementById('o2').innerHTML = b;
            document.getElementById('h2o').innerHTML = valor;
            document.getElementById('result').innerHTML = "Para " + valor + "g H2O, precisamos de " + b + "L de O2";
        }
    }
}
